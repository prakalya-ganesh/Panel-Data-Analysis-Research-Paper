...
### 📁 Repository Contents
* `ARIMA.ipynb`: Python code for panel data estimation and diagnostic tests.
* `BF - RP FINAL.docx`: Full research paper detailing literature review and discussion.
* `BF - RP DETAILS.xlsx`: Balanced panel dataset (780 observations).
